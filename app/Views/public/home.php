 ...
 *
 * Besteht die Startseite nur aus Inhaltsblöcken (Einstellung auf der
 * "Startseite gestalten"-Seite), entfällt der Standardaufbau komplett –
 * Hero, Kacheln und Wochenplan kommen dann als Blöcke.
 *
...
<?php else: ?>
    ...
    <section class="wrap" id="training">
        <?php require __DIR__ . '/_section-tiles.php'; ?>
    </section>
